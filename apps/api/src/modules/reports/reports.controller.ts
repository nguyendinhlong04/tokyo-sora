 ...
 *   · F1 · F7 → `accounting.ledger-close-period` — hai màn này thuộc §28 Kế toán,
 *     và F7 phơi cả chi phí lẫn lợi nhuận ròng nên chỉ R8 · R10.
 *
 * Hệ quả cần biết: R11 Quản lý chuỗi KHÔNG mở được F7 vì §4.2 không cấp dòng kế
 * toán cho vai trò đó. Muốn khác thì sửa ma trận trước.
 */
...
export class ReportsController {
  ...
  @Get('pnl')
  @RequirePermission('accounting.ledger-close-period')
  profitLoss(@Query('branch') branch: string, @Query() query: Record<string, string>) {
